 ...
 */
public class DViewStatsMfgProd extends DGridPaneView {

    private DGridFilterDateRange moFilterDateRange;
    
    public DViewStatsMfgProd(DGuiClient client, String title) {
        super(client, DGridConsts.GRID_VIEW_TAB, DModConsts.MX_STA_MFG_PRO, DLibConsts.UNDEFINED, title);
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT " +
                ...
                "GROUP BY j.fk_itm, i.code, i.name, it.code, it.name, u.code, u.name, p.code, p.name " +
                "ORDER BY i.name, i.code, j.fk_itm ";
    }
