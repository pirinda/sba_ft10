 ...
 */
public class DDbUserGui extends DDbRegistryUser implements DGuiUserGui {
    ...
    */
    ...
    @Override
    public DDbUserGui clone() throws CloneNotSupportedException {
        DDbUserGui registry = new DDbUserGui();
