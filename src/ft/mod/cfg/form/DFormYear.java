...
public class DFormYear extends DBeanForm {
    ...
    public DFormYear(DGuiClient client, String title) {
        setFormSettings(client, DGuiConsts.BEAN_FORM_EDIT, DModConsts.C_YEA, DLibConsts.UNDEFINED, title);
        initComponents();
    ...
    public void setRegistry(DDbRegistry registry) throws Exception {
        ...
        moDateStart.setValue(moRegistry.getYearStart());
    ...
    public DDbYear getRegistry() throws Exception {
        ...
        registry.setYearStart(moDateStart.getValue());
