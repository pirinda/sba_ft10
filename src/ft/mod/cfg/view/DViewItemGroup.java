 ...
 */
public class DViewItemGroup extends DGridPaneView {

    public DViewItemGroup(DGuiClient client, String title) {
        super(client, DGridConsts.GRID_VIEW_TAB, DModConsts.CU_GRP, DLibConsts.UNDEFINED, title);
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT " +
                "v.id_grp AS " + DDbConsts.FIELD_ID + "1, " +
                ...
                "FROM " + DModConsts.TablesMap.get(DModConsts.CU_GRP) + " AS v " +
                ...
                "ORDER BY v.name, v.code, v.id_grp ";
    }
